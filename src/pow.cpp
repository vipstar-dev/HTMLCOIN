...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params, bool fProofOfStake)
{
    ...
    return EnhancedHashRateCompensation(pindexPrev, params, fProofOfStake);
}
 ...
 */
unsigned int EnhancedHashRateCompensation(const CBlockIndex* pindexLast, const Consensus::Params& params, bool fProofOfStake)
{
